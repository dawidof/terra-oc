...
async function seed() {
  ...
  const demoLeads = await db.insert(leads).values([
    ...
    { customerId: customerIds[1], assignedManagerId: managerId, status: "new", source: "manager", estimatedTotalUsd: "35000", utmSource: "yandex", utmMedium: "cpc", utmCampaign: "brand_keywords", referrer: "https://yandex.ru/search" },
    ...
    { customerId: customerIds[5], assignedManagerId: managerId, status: "contacted", source: "manager", estimatedTotalUsd: "45000", lastContactAt: new Date(), referrer: "https://yandex.ru/search" },
    ...
    { customerId: customerIds[9], assignedManagerId: adminUser?.id, status: "negotiation", journeyStage: 3, source: "manager", estimatedTotalUsd: "62000", lastContactAt: new Date(), utmSource: "yandex", utmMedium: "cpc", utmCampaign: "brand_keywords", referrer: "https://yandex.ru/search" },
